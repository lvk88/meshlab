...
typedef std::pair<Point3m, vcg::Color4b> PointPC; // this type is used to have a simple coord+color
												  // pair to rapidly draw non manifold faces
...
public:
	DecorateBasePlugin()
	{
		typeList << DP_SHOW_AXIS << DP_SHOW_BOX_CORNERS << DP_SHOW_SELECTED_MESH << DP_SHOW_CAMERA
				 << DP_SHOW_NORMALS << DP_SHOW_TEXPARAM << DP_SHOW_VERT_QUALITY_HISTOGRAM
				 << DP_SHOW_FACE_QUALITY_HISTOGRAM << DP_SHOW_QUALITY_CONTOUR << DP_SHOW_CURVATURE
				 << DP_SHOW_LABEL;
	  ...
	  actionList.last()->setIcon(QIcon(":/images/selected_vert.png")); if(tt==DP_SHOW_SELECTED_FACE)
	...
	void DrawCamera(
		...
		Matrix44m&               currtr,
		const RichParameterList* rm,
		QPainter*                painter,
		QFont                    qf);
	void PlaceTexParam(int TexInd, int TexNum);
	void
	DrawTexParam(MeshModel& m, GLArea* gla, QPainter* painter, const RichParameterList*, QFont qf);
	...
	bool startDecorate(
		...
		GLArea* /*parent*/);
	bool
	isDecorationApplicable(const QAction* action, const MeshModel& m, QString& ErrorMessage) const;
	...
	inline QString ShowCameraDetails() const
	{
		return "MeshLab::Decoration::CameraShowCameraDetails";
	}
	...
	inline QString ShowPerVertexCurvature() const
	{
		return "MeshLab::Decoration::ShowPerVertexCurvature";
	}
	inline QString ShowPerFaceCurvature() const
	{
		return "MeshLab::Decoration::ShowPerFaceCurvature";
	}
	...
	inline QString perVertexHistBinNumParam() const
	{
		return "MeshLab::Decoration::PerVertexHistBinNumParam";
	}
	inline QString perFaceHistBinNumParam() const
	{
		return "MeshLab::Decoration::PerFaceHistBinNumParam";
	}
	inline QString perVertexHistFixedParam() const
	{
		return "MeshLab::Decoration::PerVertexUseFixedHistParam";
	}
	inline QString perFaceHistFixedParam() const
	{
		return "MeshLab::Decoration::PerFaceUseFixedHistParam";
	}
	inline QString perVertexHistFixedMinParam() const
	{
		return "MeshLab::Decoration::PerVertexFixedHistMinParam";
	}
	inline QString perFaceHistFixedMinParam() const
	{
		return "MeshLab::Decoration::PerFaceFixedHistMinParam";
	}
	inline QString perVertexHistFixedMaxParam() const
	{
		return "MeshLab::Decoration::PerVertexFixedHistMaxParam";
	}
	inline QString perFaceHistFixedMaxParam() const
	{
		return "MeshLab::Decoration::PerFaceFixedHistMaxParam";
	}
	inline QString perVertexHistFixedWidthParam() const
	{
		return "MeshLab::Decoration::PerVertexFixedHistWidthParam";
	}
	inline QString perFaceHistFixedWidthParam() const
	{
		return "MeshLab::Decoration::PerFaceFixedHistWidthParam";
	}
	inline QString perVertexHistAreaParam() const
	{
		return "MeshLab::Decoration::PerVertexAreaHistParam";
	}
	inline QString perFaceHistAreaParam() const
	{
		return "MeshLab::Decoration::PerFaceAreaHistParam";
	}
	inline QString perVertexHistFontSize() const
	{
		return "MeshLab::Decoration::PerVertexHistFontSize";
	}
	inline QString perFaceHistFontSize() const
	{
		return "MeshLab::Decoration::PerFaceHistFontSize";
	}
	...
	inline QString ShowContourColorMap() const
	{
		return "MeshLab::Decoration::ShowContourColorMap";
	}
	...
	inline QString selectedMeshBlendingColor() const
	{
		return "MeshLab::Decoration::MeshBlendingColor";
	}
