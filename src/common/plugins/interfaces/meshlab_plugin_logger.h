...
public:
	...
	// This function must be used to communicate useful information collected in the parsing/saving
	// of the files. NEVER EVER use a msgbox to say something to the user.
...
template<typename... Ts>
void MeshLabPluginLogger::realTimeLog(
	QString        id,
